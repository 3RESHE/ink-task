        ...
        <a name="pager"></a>
          ...
          <ide-app title="Editor" class="py-20 ">
            ...
            <table-row>
                ...
                <table-col>{_('Sets the height of the progress bar (default: 20px).')}</table-col>
            </table-row>
            ...
            <table-row>
                ...
                <table-col>No</table-col>
                <table-col>{_('Sets the background color of the progress container.')}</table-col>
            </table-row>
            ...
            <table-row>
                ...
                <h2 class="tx-primary tx-upper tx-30 py-20">
                {_('Progress Bar Examples')}
                </h2>

        
                <div class="mb-10">
                {_('This example demonstrates a simple progress bar with a 50% width, "info" color, and a muted background. It has rounded corners and a height of 20px for a clean, minimal look.')}
                </div>
                ...
                <div class="mb-10">
                {_('This example demonstrates a progress bar with 75% width, the "success" color, and a background of primary color. The height is set to 30px, giving it a taller appearance.')}
                </div>
                ...
                <div class="mb-10">
                {_('This example demonstrates a progress bar with a width of 40%, the "warning" color, and a height of 10px for a thinner, more compact look.')}
                </div>
                ...
                <div class="mb-10">
                {_('This example features a 100% width progress bar with the "success" color, a height of 20px, and a full-length progress bar to indicate completion.')}
                </div>
                ...
                <div class="mb-10">
                {_('This example demonstrates a progress bar with a 20% width, a height of 10px, and an "error" background color to indicate a negative status or issue. The "error" color highlights the progress bar as a warning or error state.')}
                </div>
