        ...
        <menu class="m-0 px-10 py-20 h-calc-full-40 bg-t-2 scroll-auto">
          ...
          <nav class="tx-14 tx-lh-32">
            ...
            <nav class="pl-20">
              ...
              <a class="block tx-t-1" href="#basicRating">• {_('Basic Rating Input')}</a>
              <a class="block tx-t-1" href="#customMaxRating">• {_('Rating with Custom Max')}</a>
              <a class="block tx-t-1" href="#styledRating">• {_('Styled Rating Input')}</a>
            </nav>
          </nav>
        </menu>
      </aside>
        ...
        <api-docs>
          ...
          >
            ...
            <table-row>
              ...
              <table-col>No</table-col>
              <table-col>{_('Initial rating value (defaults to 0).')}</table-col>
            </table-row>
            ...
            <table-row>
              ...
              <table-col>String/Number</table-col>
              <table-col>No</table-col>
              <table-col>{_('Maximum number of stars (defaults to 5).')}</table-col>
            </table-row>
            ...
            <table-row>
              ...
              <table-col>No</table-col>
              <table-col>{_('Disables the rating input.')}</table-col>
            </table-row>
            ...
            <table-row>
              ...
              <table-col>Function</table-col>
              <table-col>No</table-col>
              <table-col>{_('Callback with the updated rating value.')}</table-col>
            </table-row>
          ...
          <h2 class="tx-primary tx-upper tx-30 py-20">{_('Basic Rating Input')}</h2>
          <div class="mb-10">{_('A basic rating input with 5 stars.')}</div>
          ...
          <a name="customMaxRating"></a>
          <h2 class="tx-primary tx-upper tx-30 py-20">{_('Rating with Custom Max')}</h2>
          <div class="mb-10">{_('A rating input with a custom maximum number of stars.')}</div>
          <div class="basis-third lg-basis-half md-basis-full mb-20">
            <div class="bg-t-3 p-10 flex flex-col items-center justify-center">
          ...
          <h2 class="tx-primary tx-upper tx-30 py-20">{_('Styled Rating Input')}</h2>
          <div class="mb-10">{_('A styled rating input with custom size, color, and hover effects using Ink utilities.')}</div>
          <div class="basis-third lg-basis-half md-basis-full mb-20">
            <div class="bg-t-3 p-10 flex flex-col items-center justify-center">
              <field-rating 
                name="rating" 
          ...
          <!-- Navigation -->
          <nav class="flex">
            <a class="tx-primary py-40" href="/ink/ui/field/range.html">
              <element-icon name="chevron-left" theme="tx-1" />
              {_('Range')}
            </a>
            <a class="flex-grow tx-right tx-primary py-40" href="/ink/ui/field/select.html">
              {_('Select')}
