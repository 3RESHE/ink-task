    ...
    <panel-layout>
      ...
      <aside right>
        <menu class="m-0 px-10 py-20 h-calc-full-40 bg-t-2 scroll-auto">
          ...
          <nav class="tx-14 tx-lh-32">
            <a class="block tx-t-0" href="#currency">{_('Currency Field')}</a>
            <nav class="pl-20">
      ...
      <main>
        <api-docs>
          ...
          <a name="currency"></a>
          <h1 class="tx-primary tx-upper tx-30 py-20">{_('Currency Field')}</h1>
          <ide-app title="Currency Field" class="py-20">
          ...
          <layout-table top head="py-16 px-12 bg-t-1 b-solid b-black bt-1 bb-0 bx-0" body="py-16 px-12 b-solid b-black bt-1 bb-0 bx-0" odd="bg-t-0" even="bg-t-1">
            ...
            <table-row>
              ...
              <table-col>String</table-col>
              <table-col>No</table-col>
              <table-col>{_('Initial currency code (e.g., "PHP")')}</table-col>
            </table-row>
            <table-row>
              <table-col>placeholder</table-col>
              <table-col>String</table-col>
              <table-col>No</table-col>
              <table-col>{_('Text when no currency is selected (default: "Select Currency")')}</table-col>
            </table-row>
            <table-row>
          ...
          <div class="mb-10">A simple currency dropdown.</div>
          ...
          <div class="mb-10">Currency field with an initial value.</div>
          <div class="bg-t-3 p-10 mb-10">
          ...
          <nav class="flex">
            <a class="tx-primary py-40" href="/ink/ui/field/country.html">
              <element-icon name="chevron-left" theme="tx-1" />{_('Country Field')}
            </a>
            <a class="flex-grow tx-right tx-primary py-40" href="/ink/ui/field/date.html">
              {_('Date Field')}<element-icon name="chevron-right" theme="tx-1" />
            </a>
          </nav>
