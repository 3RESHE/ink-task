    ...
    <panel-layout>
      ...
      <aside right>
        <menu class="m-0 px-10 py-20 h-calc-full-40 bg-t-2 scroll-auto">
          ...
          <nav class="tx-14 tx-lh-32">
            <a class="block tx-t-0" href="#date">{_('Date Field')}</a>
            <nav class="pl-20">
      ...
      <main>
        <api-docs>
          ...
          <a name="date"></a>
          <h1 class="tx-primary tx-upper tx-30 py-20">{_('Date Field')}</h1>
          <ide-app title="Date Field" class="py-20">
          ...
          <layout-table top head="py-16 px-12 bg-t-1 b-solid b-black bt-1 bb-0 bx-0" body="py-16 px-12 b-solid b-black bt-1 bb-0 bx-0" odd="bg-t-0" even="bg-t-1">
            ...
            <table-row>
              ...
              <table-col>No</table-col>
              <table-col>{_('Disables the date picker')}</table-col>
            </table-row>
            <table-row>
            ...
            <table-row>
              ...
              <table-col>String</table-col>
              <table-col>No</table-col>
              <table-col>{_('Regex pattern for validation (e.g., "[0-9]{4}-[0-9]{2}-[0-9]{2}")')}</table-col>
            </table-row>
            <table-row>
              <table-col>readonly</table-col>
              <table-col>Boolean</table-col>
              <table-col>No</table-col>
              <table-col>{_('Makes the date picker read-only')}</table-col>
            </table-row>
            <table-row>
            ...
            <table-row>
              ...
              <table-col>No</table-col>
              <table-col>{_('Initial date value (e.g., "2020-01-01" or Date object), converted to YYYY-MM-DD')}</table-col>
            </table-row>
            <table-row>
              <table-col>placeholder</table-col>
              <table-col>String</table-col>
              <table-col>No</table-col>
              <table-col>{_('Placeholder text for the date input')}</table-col>
            </table-row>
            <table-row>
            ...
            <table-row>
              ...
              <table-col>Function</table-col>
              <table-col>No</table-col>
              <table-col>{_('Callback with formatted date string (YYYY-MM-DD)')}</table-col>
            </table-row>
          </layout-table>

          <a name="basic"></a>
          <h2 class="tx-primary tx-upper tx-30 py-20">{_('Basic Usage')}</h2>
          <div class="mb-10">A simple date field with a placeholder.</div>
          ...
          <div class="mb-10">Date field with different states: value, disabled, required.</div>
          ...
          <div class="mb-10">Date field with custom styling, initial value, and update callback.</div>
          <div class="bg-t-3 p-10 mb-10">
            <field-date 
              name="custom-date" 
          ...
          <nav class="flex">
            <a class="tx-primary py-40" href="/ink/ui/field/currency.html">
              <element-icon name="chevron-left" theme="tx-1" />{_('Currency Field')}
            </a>
            <a class="flex-grow tx-right tx-primary py-40" href="/ink/ui/field/datetime.html">
              {_('Datetime Field')}<element-icon name="chevron-right" theme="tx-1" />
            </a>
          </nav>
