    ...
    <panel-layout>
      ...
      <main>
        <api-docs>
          ...
          <ide-app title="Country Format" class="py-20">
          ...
          >
            ...
            <table-row>
              ...
              <table-col>{_('Two-letter country code (e.g., "us", "fr"). Case-insensitive.')}</table-col>
            </table-row>
            ...
            <table-row>
              ...
              <table-col>{_('Displays the flag. If `true`, uses default size (16px). If an object, accepts size props (e.g., `sm`, `md`). Set to `false` to hide.')}</table-col>
            </table-row>
            ...
            <table-row>
              ...
              <table-col>No</table-col>
              <table-col>{_('Displays the country name. Defaults to `true` if `flag` is unset; set to `false` to hide.')}</table-col>
            </table-row>
          ...
          <div class="mb-10">{_('Displays a country flag and name with default settings.')}</div>
          ...
          <div class="mb-10">{_('Shows only the country flag, hiding the name.')}</div>
          <div class="bg-t-3 p-10 mb-20">
          ...
          <div class="mb-10">{_('Shows only the country name, hiding the flag.')}</div>
          <div class="bg-t-3 p-10 mb-20">
          ...
          <nav class="flex">
            <a class="tx-primary py-40" href="/ink/ui/format/color.html">
              <element-icon name="chevron-left" theme="tx-1" />{_('Color')}
            </a>
