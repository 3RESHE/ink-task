var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\field\filelist.ink
...
`, false)
  ...
  var Filelist_1bad9ce547117f592df7 = class extends import_Component17.default {
  ...
  img + a {
    ...
    template() {
      ...
      const state = (0, import_signal.default)({ queued: 0, uploaded: value });
      const handlers = {
        change: (e) => {
  ...
  `, false),
    ...
    `, false),
            ...Object.entries(state.value.uploaded).map(([_3, url]) => [
              import_Registry17.default.createText(`
      `, false),
              import_Registry17.default.createElement("input", { "name": name, "type": `hidden`, "value": url }).element,
              import_Registry17.default.createText(`
    `, false)
            ]).flat(),
            import_Registry17.default.createText(`
...
`, false),
  ...
  `, false),
          ...!!image ? [
            import_Registry17.default.createText(`
    `, false),
            import_Registry17.default.createComponent("field-input", Input_cb7a6224432a087beaf2, { ...attributes, "type": `file`, "accept": `image/*`, "change": handlers.change, "multiple": true }).element,
            import_Registry17.default.createText(`
  `, false)
          ] : true ? [
            ,
            import_Registry17.default.createText(`
    `, false),
            import_Registry17.default.createComponent("field-input", Input_cb7a6224432a087beaf2, { ...attributes, "type": `file`, "change": handlers.change, "multiple": true }).element,
            import_Registry17.default.createText(`
  `, false)
          ] : [],
          import_Registry17.default.createText(`
      ...
      `, false),
        ...
        `, false),
                ...!!image ? [
                  import_Registry17.default.createText(`
          `, false),
                  import_Registry17.default.createElement("img", { "src": url, "alt": `preview` }).element,
                  import_Registry17.default.createText(`
        `, false)
                ] : [],
                import_Registry17.default.createText(`
        `, false),
                import_Registry17.default.createElement("a", { "href": url, "target": `_blank`, "rel": `noreferrer` }, [
                  import_Registry17.default.createText(`
          `, false),
        ...
        `, false)
                ...
                import_Registry17.default.createText(`
        `, false),
                import_Registry17.default.createElement("em", { "click": () => handlers.remove(i) }, [
                  import_Registry17.default.createText(`
          &times;
        `, false)
                ]).element,
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/field/file.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  return __toCommonJS(filelist_exports);
})();
