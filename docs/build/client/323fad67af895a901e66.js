var InkAPI = (() => {
  ...
  var require_StyleSet = __commonJS({
    "../../node_modules/@stackpress/ink/dist/style/StyleSet.js"(exports) {
      ...
      function styleset(styles = {}) {
        return new StyleSet11(Object.entries(styles));
      }
      var StyleSet11 = class extends Map {
  ...
  // ink-document-client-resolver:C:\Users\anetu\dev\ink-task\packages\ink-web\src\pages\ui\format\code.ink
  var code_exports = {};
...
`, false)
  ...
  .terminal span {
    ...
    template() {
      ...
      const childlist2 = (0, import_ink3.children)();
      let snippet = childlist2[0]?.textContent || "";
      if (detab) {
...
`, false)
  ...
  var Code_c09ccb1e08c8796465cf = class extends import_Component16.default {
  ...
  .terminal span {
    ...
    template() {
      ...
      const children4 = this.originalChildren;
      let snippet = value || children4[0]?.textContent || "";
      if (detab) {
        snippet = snippet.replace(
          new RegExp(`\\n {${detab}}`, "g"),
          "\n"
      ...
      const highlight = (event) => {
        ...
        const code = import_prismjs2.default.highlight(snippet, import_prismjs2.default.languages[lang], lang);
        event.detail.target.innerHTML = code;
        if (numbers) {
          const match = code.match(/\n(?!$)/g);
          const total = match ? match.length + 1 : 1;
      ...
      return () => [
        import_Registry16.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css` }).element,
        import_Registry16.default.createText(`
`, false),
        import_Registry16.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css` }).element,
        import_Registry16.default.createText(`
`, false),
        ...!!(lang === "bash") ? [
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("div", { "class": `terminal` }, [
            import_Registry16.default.createElement("span", {}, [
              import_Registry16.default.createText(`$`, false)
            ]).element,
            import_Registry16.default.createText(` `, false),
...
`, false)
  ...
  `, false),
          ...!!numbers ? [
            import_Registry16.default.createText(`
    `, false),
            import_Registry16.default.createElement("pre", { "class": `snippet line-numbers` }, [
              import_Registry16.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_Registry16.default.createText(`
  `, false)
          ] : true ? [
            ...
            import_Registry16.default.createText(`
    `, false),
            import_Registry16.default.createElement("pre", { "class": `snippet pad` }, [
              import_Registry16.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_Registry16.default.createText(`
  `, false)
...
`, false)
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#Code` }, [
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicCode` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Code Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#inlineCode` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Inline Code Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#lineNumbersCode` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Code with Line Numbers"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#terminalCode` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Terminal Code Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledCode` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Code Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `Code` }, []),
                  import_Document.default.createText(`
          `, false),
                  ...
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("ide-app", { "title": `Code`, "class": `py-20` }, [
                    import_Document.default.createText(`
            `, false),
          ...
          `, false),
                  import_Document.default.createElement("p", { "class": `mb-20` }, [
                    ...this._toNodeList(_("The `<format-code>` component displays syntax-highlighted code snippets using Prism.js. Use Ink utilities via the `class` prop for additional styling."))
                  ]),
                  import_Document.default.createText(`
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`lang`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Programming language for syntax highlighting (e.g., "js", "bash", "html"). Defaults to "markup".'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If true, displays line numbers on the left. Defaults to false."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If true, renders the code inline instead of as a block. Defaults to false."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`trim`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If true, trims whitespace from both ends of the code snippet. Defaults to false."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`ltrim`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If true, trims whitespace from the start of the code snippet. Defaults to false."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`rtrim`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If true, trims whitespace from the end of the code snippet. Defaults to false."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`detab`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Replaces leading spaces (in multiples of this value) with a newline. Defaults to 0."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("The code snippet to display. If not provided, uses the component\u2019s child content."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Ink utility classes for additional styling (e.g., "tx-lg p-10").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          <!-- Basic Code Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `basicCode` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Basic Code Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A basic code snippet displayed as a block."))
                  ]),
                  import_Document.default.createText(`
          `, false),
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-code", { "lang": `js`, "value": basicCode }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Inline Code Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `inlineCode` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Inline Code Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A code snippet displayed inline within text."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex flex-center` }, [
                      import_Document.default.createText(`
              Use the `, false),
                      import_Document.default.createElement("format-code", { "lang": `html`, "inline": true, "value": inlineCode }),
                      import_Document.default.createText(` tag for layout.
            `, false)
                    ]),
                    import_Document.default.createText(`
          `, false)
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `lineNumbersCode` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Code with Line Numbers"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A code snippet with line numbers enabled."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-200 flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-code", { "lang": `js`, "numbers": true, "detab": 4, "value": jsCode }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
...
greet('World');";
          ...
          <!-- Styled Code Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `styledCode` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Styled Code Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A styled code snippet with custom Ink utilities."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-200 flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-code", { "lang": `css`, "numbers": true, "class": `tx-lg p-10 b-dashed b-t-3`, "value": cssCode }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
    ...
    padding: 10px;
          ...
          `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/color.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "323fad67af895a901e66";
