var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\phone.ink
  var phone_exports = {};
...
`, false)
  ...
  var Phone_7374911bf46bf2c57d53 = class extends import_Component16.default {
...
`, false),
        import_Registry16.default.createElement("a", { ...attributes, "href": `tel:${value}` }, [
...
`, false)
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#Phone` }, [
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicPhone` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Phone Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#customLabel` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Custom Label Phone Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledPhone` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Phone Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#additionalAttributes` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Additional Attributes Phone Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `Phone` }, []),
                  import_Document.default.createText(`
          `, false),
                  ...
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("ide-app", { "title": `Phone`, "class": `py-20` }, [
                    import_Document.default.createText(`
            `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("The phone number to format as a `tel:` link."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Custom text to display instead of the phone number (defaults to `value`)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the font size (e.g., "16px", "14px"). Defaults to "13px".'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the link color (e.g., "var(--tx-1)", "red").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Applies underline styling to the link if `true`."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Inline styles for the container (ignored; use `class` with Ink utilities instead)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`...attributes`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Additional HTML attributes (e.g., `target`, `rel`) for the `<a>` tag."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          <!-- Basic Phone Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `basicPhone` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Basic Phone Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a phone number as a clickable `tel:` link, matching the reference example."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `customLabel` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Custom Label Phone Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a phone link with a custom label instead of the phone number."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-phone", { "value": `+63 (917) 555-2424`, "label": `Call Us` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Styled Phone Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `styledPhone` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Styled Phone Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a phone link with custom styling (bold, color, underline)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-phone", { "value": `+63 (917) 555-2424`, "bold": true, "color": `var(--tx-2)`, "underline": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `additionalAttributes` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Additional Attributes Phone Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a phone link with additional HTML attributes (e.g., `target` and `rel`)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-phone", { "value": `+63 (917) 555-2424`, "target": `_blank`, "rel": `noopener noreferrer` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/format/overflow.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/price.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "e2ecce1e6b491b033989";
  ...
  return __toCommonJS(phone_exports);
})();
