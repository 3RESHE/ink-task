var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\field\currency.ink
...
`, false)
  ...
  var Currency_f19a5f2e28ee751b9497 = class extends import_Component16.default {
  ...
  .selected .option:hover {
    ...
    template() {
      ...
      const options = intl_default.filter((country) => country.currencyOrigin).map((country) => {
...
`, false)
  ...
  var BUILD_ID = "4f8073fb2970ac56e494";
  ...
  return __toCommonJS(currency_exports);
})();
