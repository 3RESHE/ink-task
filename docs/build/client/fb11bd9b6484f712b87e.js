var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\docs\static-site.ink
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("div", { "class": `flex scroll-x-auto pt-5 pl-5` }, [
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("element-tab", { "on": true, "class": `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, "active": `bg-black tx-white`, "inactive": `bg-t-1 tx-t-1`, "group": `static`, "selector": `#index-ts` }, [
                          import_Document.default.createText(`
                  src/index.ts
                `, false)
                        ]),
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("element-tab", { "class": `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, "active": `bg-black tx-white`, "inactive": `bg-t-1 tx-t-1`, "group": `static`, "selector": `#page-ink` }, [
                          import_Document.default.createText(`
                  src/page.ink
                `, false)
                        ]),
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("element-tab", { "class": `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, "active": `bg-black tx-white`, "inactive": `bg-t-1 tx-t-1`, "group": `static`, "selector": `#package-json` }, [
                          import_Document.default.createText(`
                  package.json
                `, false)
                        ]),
            ...
            `, false),
              ...
              `, false)
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("element-tab", { "on": true, "class": `pl-15 pt-10 block`, "active": `tx-white`, "inactive": `tx-muted`, "group": `static`, "selector": `#index-ts` }, [
                        import_Document.default.createText(`
                `, false),
              ...
              `, false)
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("element-tab", { "class": `pl-15 pt-10 block`, "active": `tx-white`, "inactive": `tx-muted`, "group": `static`, "selector": `#page-ink` }, [
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("element-icon", { "name": `file` }),
                        import_Document.default.createText(`
              ...
              `, false)
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("element-tab", { "class": `pt-10 block`, "active": `tx-white`, "inactive": `tx-muted`, "group": `static`, "selector": `#package-json` }, [
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("element-icon", { "name": `file` }),
                        import_Document.default.createText(`
            ...
            `, false),
              ...
              `)
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("ide-code", { "id": `index-ink`, "style": `display:none`, "numbers": true, "trim": true, "detab": 16 }, [
                        ...this._toNodeList(`
                <style>
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/docs/single-page.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/docs/component-publisher.html` }, [
                      import_Document.default.createText(`
              `, false),
                      ...this._toNodeList(_("Component Publisher")),
                      import_Document.default.createText(`
...
`, false)
  ...
  var BUILD_ID = "fb11bd9b6484f712b87e";
