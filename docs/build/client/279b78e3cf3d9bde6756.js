var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\anetu\dev\ink-task\packages\ink-web\src\pages\ui\format\table.ink
  var table_exports = {};
...
`, false)
  ...
  var Table_317790ce57308084dd5b = class extends import_Component16.default {
    ...
    template() {
      ...
      if (background) {
        (0, import_color3.default)(background, styles, false, "td,th", "background-color");
      }
      if (header) {
        (0, import_color3.default)(background, styles, false, "tr th", "background-color");
      }
      if (stripe) {
        (0, import_color3.default)(
          stripe,
          styles,
          false,
      ...
      if (border) {
        ...
        (0, import_color3.default)(border, styles, false, "td", "border-top-color");
      }
      if (top || left || right) {
...
`, false),
        import_Registry16.default.createElement("div", {}, [
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("table", {}, [
            import_Registry16.default.createText(`
    `, false),
            import_Registry16.default.createElement("thead", {}, [
              import_Registry16.default.createText(`
      `, false),
              import_Registry16.default.createElement("tr", {}, [
                import_Registry16.default.createText(`
        `, false),
                ...Object.entries(keys).map(([i, label]) => [
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("th", {}, [
      ...
      `, false),
        ...
        `, false),
                ...Object.entries(row).map(([_2, value2]) => [
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("td", {}, [
...
`, false)
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#Table` }, [
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicTable` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Table Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#stickyHeader` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Sticky Header Table Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#themedTable` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Themed Table Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#simpleTable` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Simple Table Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `Table` }, []),
                  import_Document.default.createText(`
          `, false),
                  ...
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("ide-app", { "title": `Table`, "class": `py-20` }, [
                    import_Document.default.createText(`
            `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("An array of objects representing table rows (defaults to an empty array `[]`)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, makes the header row sticky at the top."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, makes the first column sticky on the left."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, makes the last column sticky on the right."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Padding for cells in pixels (e.g., `10` for 10px)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Text alignment for cells ("left", "center", "right").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Background color or theme for all cells (e.g., "bg-1").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Border-top color or theme for cells (e.g., "black").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Background color or theme for header cells (e.g., "bg-2").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`stripe`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Background color or theme for alternating rows (e.g., "bg-2").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the text color (e.g., "var(--tx-1)", "red").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          <!-- Basic Table Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `basicTable` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Basic Table Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a table with custom padding, alignment, and theming, matching the reference example."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `stickyHeader` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Sticky Header Table Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a table with a sticky header."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center`, "style": `height: 200px;` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-table", { "value": table, "top": true, "padding": `10`, "align": `center`, "background-theme": `bg-1`, "stripe-theme": `bg-2`, "header-theme": `bg-2`, "border-theme": `black` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Themed Table Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `themedTable` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Themed Table Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a table with custom colors and alignment."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-table", { "value": table, "padding": `5`, "align": `left`, "background": `var(--bg-3)`, "stripe": `var(--bg-4)`, "header": `var(--bg-4)`, "border": `var(--tx-1)` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Simple Table Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `simpleTable` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Simple Table Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a basic table with default styles."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-table", { "value": table }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/format/separated.html` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("element-icon", { "name": `chevron-left`, "theme": `tx-1` }),
                      import_Document.default.createText(`
              `, false),
                      ...this._toNodeList(_("Separated")),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/taglist.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "279b78e3cf3d9bde6756";
