...
`, false)
  ...
  var Textlist_e6367e273a85cfed73bc = class extends import_Component16.default {
    ...
    template() {
      ...
      const handlers = {
        ...
        create: (index, value2) => {
          ...
          const slot = import_Registry16.default.createElement(
            "slot",
            { name: `row-${index}` }
          ).element;
...
`, false)
  ...
  var BUILD_ID = "ba50fed0f3709fe0004f";
