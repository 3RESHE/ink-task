var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\separated.ink
...
`, false)
  ...
  var Separated_c0600ef713f622e638b0 = class extends import_Component16.default {
...
`, false)
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#Separated` }, [
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicSeparated` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Separated Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledSeparated` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Separated Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#defaultSeparator` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Default Separator Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `Separated` }, []),
                  import_Document.default.createText(`
          `, false),
                  ...
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("ide-app", { "title": `Separated`, "class": `py-20` }, [
                    import_Document.default.createText(`
            `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("The array of items to separate (defaults to an empty array `[]`)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('The separator to use ("line" for new lines, or any string like "," or " "). Defaults to " ".'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `basicSeparated` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Basic Separated Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders an array with items separated by new lines, matching the reference example."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders an array with a custom separator (e.g., comma)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-separated", { "value": items, "separator": `,` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `styledSeparated` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Styled Separated Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders an array with custom styling (bold, color, size)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-separated", { "value": ["Foo", "bar"], "separator": `line`, "bold": true, "color": `var(--tx-2)`, "size": `16px` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `defaultSeparator` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Default Separator Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders an array with the default space separator."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-separated", { "value": items }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/format/rating.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "23216d205348510ffbfa";
  ...
  return __toCommonJS(separated_exports);
})();
