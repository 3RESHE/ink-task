var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\metadata.ink
...
`, false)
  ...
  var Metadata_87d54dded027bddff214 = class extends import_Component16.default {
    ...
    template() {
      ...
      if (background) {
        (0, import_color3.default)(background, styles, false, "td", "background-color");
      }
      if (stripe) {
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicMetadata` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Metadata Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#formattedMetadata` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Formatted Metadata Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledMetadata` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Metadata Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#borderedMetadata` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Bordered Metadata Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("An object of key-value pairs to display as metadata (defaults to an empty object)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("Sets the padding of table cells in pixels (e.g., `10` for 10px)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the text alignment of table cells (e.g., "center", "left", "right").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, formats keys by converting underscores/hyphens to spaces and capitalizing words (e.g., `created_at` to `Created At`)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`background-theme`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the background color for all table cells using a theme value (e.g., "bg-1" maps to `var(--bg-1)`). Internally maps to the `background` prop.'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`stripe-theme`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the background color for odd-numbered rows to create a striping effect (e.g., "bg-2" maps to `var(--bg-2)`). Internally maps to the `stripe` prop.'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`border-theme`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Sets the border-top color for table cells and enables a 1px solid border-top (e.g., "black"). Internally maps to the `border` prop.'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a simple metadata table with default styling."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-metadata", { "value": metadata, "padding": `10`, "align": `center` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `formattedMetadata` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Formatted Metadata Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a metadata table with formatted keys (e.g., `created_at` to `Created At`)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-metadata", { "value": metadata, "padding": `10`, "align": `center`, "format": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a metadata table with custom padding, alignment, background, and striping."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-metadata", { "value": metadata, "padding": `10`, "align": `center`, "background-theme": `bg-1`, "stripe-theme": `bg-2`, "format": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `borderedMetadata` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Bordered Metadata Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a metadata table with a border-top and additional styling."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
          ...
          `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/number.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "3889e637b5d553883748";
