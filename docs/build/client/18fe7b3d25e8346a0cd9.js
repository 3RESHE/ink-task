var InkAPI = (() => {
  ...
  var require_select = __commonJS({
    "../../node_modules/@stackpress/ink-ui/utilities/select.js"(exports) {
      ...
      function makeOptions(children4) {
      ...
      function getHandlers2(host, options, slot = true) {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\field\country.ink
  var country_exports = {};
...
`, false)
  ...
  var Country_e24d0db854af71ec9fc5 = class extends import_Component16.default {
  ...
  .selected .option:hover {
    ...
    template() {
      ...
      const options = intl_default.map((country) => {
      ...
      const { state, clear, toggle, filter, add } = (0, import_select.getHandlers)(this, options, false);
      return () => [
  ...
  `, false),
    ...
    `, false),
            ...Object.entries(state.value.values).map(([_2, value]) => [
              import_Registry16.default.createText(`
      `, false),
              import_Registry16.default.createElement("input", { "type": `hidden`, "name": name, "value": value.toString() }).element,
              import_Registry16.default.createText(`
    `, false)
            ]).flat(),
            import_Registry16.default.createText(`
...
`, false),
        import_Registry16.default.createElement("template", { "type": `shadow` }, [
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("link", { "rel": `stylesheet`, "type": `text/css`, "href": `https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css` }).element,
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("div", { "class": `select` }, [
            import_Registry16.default.createText(`
    `, false),
            import_Registry16.default.createElement("div", { "class": `display` }, [
              import_Registry16.default.createText(`
      `, false),
              import_Registry16.default.createElement("div", { "class": `selected`, "click": toggle }, [
                import_Registry16.default.createText(`
        `, false),
        ...
        `, false)
                  ...
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("span", { "class": `placeholder` }, [
                    import_Registry16.default.createText(`
            `, false),
      ...
      `, false),
              ...!!(state.value.selected.length > 1) ? [
                import_Registry16.default.createText(`
        `, false),
                import_Registry16.default.createElement("em", { "class": `count` }, [
      ...
      `, false),
              ...!!(state.value.selected.length > 0) ? [
                import_Registry16.default.createText(`
        `, false),
                import_Registry16.default.createElement("i", { "class": `clear fas fa-fw fa-times`, "click": clear }, []).element,
                import_Registry16.default.createText(`
      `, false)
              ] : [],
              import_Registry16.default.createText(`
      `, false),
        ...
        `, false),
                ...!!state.value.show ? [
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("i", { "class": `toggle fas fa-fw fa-caret-up`, "click": toggle }, []).element,
                  import_Registry16.default.createText(`
        `, false)
                ] : true ? [
                  ,
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("i", { "class": `toggle fas fa-fw fa-caret-down`, "click": toggle }, []).element,
                  import_Registry16.default.createText(`
        `, false)
                ] : [],
                import_Registry16.default.createText(`
    ...
    `, false),
            ...!!(state.value.show && (state.value.filtered.length > 0 || state.value.query.length > 0)) ? [
              import_Registry16.default.createText(`
      `, false),
              import_Registry16.default.createElement("div", { "class": `dropdown` }, [
                import_Registry16.default.createText(`
        `, false),
                import_Registry16.default.createElement("div", { "class": `form` }, [
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("input", { "class": `input`, "value": state.value.query, "keyup": filter }).element,
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("i", { "class": `search fas fa-fe fa-search` }, []).element,
                  import_Registry16.default.createText(`
        `, false)
                ]).element,
                import_Registry16.default.createText(`
        `, false),
                import_Registry16.default.createElement("div", { "class": `options` }, [
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#countryWithValue` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Country with Value"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledCountry` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Country"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Initial selected country code (e.g., "US"). Single selection only.'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Text shown when no country is selected. Defaults to "Select Country".'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A simple country selector with default placeholder."))
                  ]),
                  import_Document.default.createText(`
          `, false),
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex align-center justify-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("field-country", { "name": `country`, "class": `relative z-1` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Country with Value -->
          `, false),
                  import_Document.default.createElement("a", { "name": `countryWithValue` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Country with Value"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A country selector with an initial selected value."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-calc-third-10 lg-basis-calc-half-10 md-basis-full` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex align-center justify-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("field-country", { "name": `country`, "value": `US`, "class": `relative z-1` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A country selector with a custom placeholder text."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-calc-third-10 lg-basis-calc-half-10 md-basis-full` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex align-center justify-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("field-country", { "name": `country`, "placeholder": `Choose a Country`, "class": `relative z-1` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          <!-- Styled Country -->
          `, false),
                  import_Document.default.createElement("a", { "name": `styledCountry` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Styled Country"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A country selector with custom width and styling."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-calc-third-10 lg-basis-calc-half-10 md-basis-full` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-120 flex align-center justify-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("field-country", { "name": `country`, "value": `CA`, "class": `w-200 relative z-1`, "style": `border-color: var(--primary);` }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/field/color.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/field/currency.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "18fe7b3d25e8346a0cd9";
