var InkAPI = (() => {
  ...
  var require_Registry = __commonJS({
    "../../node_modules/@stackpress/ink/dist/client/Registry.js"(exports) {
      ...
      var ClientRegistry15 = class _ClientRegistry {
        static get elements() {
      ...
      ClientRegistry15._elements = /* @__PURE__ */ new Map();
      exports.default = ClientRegistry15;
    }
  });
  ...
  var require_Component = __commonJS({
    "../../node_modules/@stackpress/ink/dist/client/Component.js"(exports) {
      ...
      var Emitter_1 = __importDefault(require_Emitter());
      var data_1 = __importDefault(require_data());
      var ClientComponent14 = class _ClientComponent extends HTMLElement {
      ...
      exports.default = ClientComponent14;
    }
  });
  ...
  var require_StyleSet = __commonJS({
    "../../node_modules/@stackpress/ink/dist/style/StyleSet.js"(exports) {
      ...
      function styleset(styles = {}) {
        return new StyleSet9(Object.entries(styles));
      }
      var StyleSet9 = class extends Map {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\500.ink
  var __exports = {};
  __export(__exports, {
    BUILD_ID: () => BUILD_ID,
    ClientRegistry: () => import_Registry14.default,
...
`, false),
  ...
  var Table_cb9231b6c52140a254d4 = class extends import_Component2.default {
...
`, false),
  ...
  var Row_0b3723ad0a2356b54f11 = class extends import_Component3.default {
...
`, false),
  ...
  var Thead_afbcee18613ce58fb77c = class extends import_Component4.default {
...
`, false),
        import_Registry4.default.createComponent("table-row", Row_0b3723ad0a2356b54f11, {}, [
  ...
  var Tbody_95f498c1427be6bf7334 = class extends import_Component5.default {
...
`, false),
  ...
  var Tfoot_874bedd042c5f2db7353 = class extends import_Component6.default {
...
`, false),
  ...
  // ink-component-resolver:C:\Users\Win 10\dev\ink-task\node_modules\@stackpress\ink-ui\layout\table.ink
  var Table_02bc3cbacda5727a0af3 = class extends import_Component7.default {
    ...
    template() {
      ...
      headers.length && this.appendChild(
        import_Registry7.default.createComponent(
          "table-thead",
...
`, false),
        ...!!sticky ? [
          import_Registry7.default.createText(`
  `, false),
          import_Registry7.default.createComponent("table-wrapper", Table_cb9231b6c52140a254d4, {}, [
            import_Registry7.default.createText(`
    `, false),
...
`, false)
  ...
  var Head_d8755504d9458a2c21da = class extends import_Component8.default {
...
`, false),
        ...!!(wrap1 || wrap2 || wrap3 || wrap4 || wrap5) ? [
          import_Registry8.default.createText(`
  `, false),
          import_Registry8.default.createElement("div", { "class": `wrap` }, []).element,
          import_Registry8.default.createText(`
`, false)
        ] : []
      ];
  ...
  var Col_f45aa9d13a1588f1d9ab = class extends import_Component9.default {
...
`, false),
        ...!!(wrap1 || wrap2 || wrap3 || wrap4 || wrap5) ? [
          import_Registry9.default.createText(`
  `, false),
          import_Registry9.default.createElement("div", { "class": `wrap` }, []).element,
          import_Registry9.default.createText(`
`, false)
        ] : []
      ];
  ...
  var App_4ec139eab67151540039 = class extends import_Component10.default {
...
`, false),
        import_Registry10.default.createElement("div", { "class": `curved scroll-hidden shadow-0-0-10-0-0-0-5` }, [
          import_Registry10.default.createText(`
  `, false),
          import_Registry10.default.createElement("div", { "class": `relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16` }, [
            import_Registry10.default.createText(`
    `, false),
            import_Registry10.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_Registry10.default.createText(`
    `, false),
            import_Registry10.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_Registry10.default.createText(`
    `, false),
            ...
            import_Registry10.default.createText(`
    `, false),
            import_Registry10.default.createElement("span", { "class": `flex flex-center h-full w-full absolute top-0 left-0` }, [
              import_Registry10.default.createText(`
      `, false),
  ...
  `, false)
          ...
          import_Registry10.default.createText(`
  `, false),
          import_Registry10.default.createElement("div", { "class": `bg-black tx-t-1 relative`, "style": style }, [
...
`, false)
  ...
  var Code_5387662ecbed97347dd0 = class extends import_Component11.default {
  ...
  .terminal span {
    ...
    template() {
      ...
      return () => [
        import_Registry11.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css` }).element,
        import_Registry11.default.createText(`
`, false),
        import_Registry11.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css` }).element,
        import_Registry11.default.createText(`
`, false),
        ...!!(lang === "bash") ? [
          import_Registry11.default.createText(`
  `, false),
          import_Registry11.default.createElement("div", { "class": `terminal` }, [
            import_Registry11.default.createElement("span", {}, [
...
`, false)
  ...
  `, false),
          ...!!numbers ? [
            import_Registry11.default.createText(`
    `, false),
            import_Registry11.default.createElement("pre", { "class": `snippet line-numbers` }, [
              import_Registry11.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_Registry11.default.createText(`
  `, false)
          ] : true ? [
            ...
            import_Registry11.default.createText(`
    `, false),
            import_Registry11.default.createElement("pre", { "class": `snippet pad` }, [
              import_Registry11.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_Registry11.default.createText(`
  `, false)
...
`, false)
  ...
  // ink-component-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\components\ide\preview.ink
  ...
  var Preview_62eb1e835132946fd19f = class extends import_Component12.default {
...
`, false),
        import_Registry12.default.createElement("div", { "class": `bg-white tx-black arial p-10 h-full` }, [
  ...
  // ink-component-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\components\i18n\translate.ink
  var Translate_794a00a5e900fca28310 = class extends import_Component13.default {
    ...
    `, false),
        ...!!p ? [
          import_Registry13.default.createText(`
      `, false),
          import_Registry13.default.createElement("p", {}, [
    ...
    `, false)
          ...
          import_Registry13.default.createText(`
      `, false),
          import_Registry13.default.createElement("li", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_Registry13.default.createText(`
    `, false)
          ...
          import_Registry13.default.createText(`
      `, false),
          import_Registry13.default.createElement("div", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_Registry13.default.createText(`
    `, false)
  ...
  var TemplateDocument = class _TemplateDocument extends import_Document2.default {
    ...
    template() {
      ...
      const { code, status, stack = [] } = (0, import_ink4.props)("document");
...
`, false)
  ...
  var BUILD_ID = "ce266f488bf7fefe4503";
