var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\taglist.ink
  var taglist_exports = {};
...
`, false)
  ...
  var Badge_04e709456157a0a384e7 = class extends import_Component16.default {
...
`, false),
  ...
  var Taglist_bc16ceebd2a003958ea6 = class extends import_Component17.default {
...
`, false),
        ...Object.entries(value).map(([_2, tag]) => [
          import_Registry17.default.createText(`
  `, false),
          import_Registry17.default.createComponent("element-badge", Badge_04e709456157a0a384e7, { "curved": !!curved, "rounded": !!rounded, "pill": !!pill, "info": !!info, "warning": !!warning || defaultColor, "success": !!success, "error": !!error, "muted": !!muted, "primary": !!primary, "color": color, "secondary": !!secondary, "outline": !!outline, "solid": !!solid, "transparent": !!transparent }, [
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#basicTaglist` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Basic Taglist Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#customColor` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Custom Color Taglist Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#styledTaglist` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Styled Taglist Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#defaultTheme` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Default Theme Taglist Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#transparentTaglist` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Transparent Taglist Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#advancedStyledTaglist` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Advanced Styled Taglist Format"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("The array of strings to render as tags (defaults to an empty array `[]`)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a curved shape to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a rounded shape to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a pill shape to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies an info color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a warning color theme (default if no color specified)."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a success color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies an error color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a muted color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a primary color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a secondary color theme."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('A custom color value (e.g., "var(--tx-1)", "red") to override themes.'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies an outline style to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a solid style to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_("If `true`, applies a transparent style to the badges."))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Defines the container\u2019s display format (e.g., "block", "flex", "inline-block"). Defaults to "inline-block".'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        ...this._toNodeList(_('Ink utility classes to style the container (e.g., "p-4", "bg-t-2").'))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with pill-shaped badges, matching the reference example."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with a custom color."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-taglist", { "value": tags, "pill": true, "success": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with multiple styling options."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-taglist", { "value": ["Foo", "bar"], "pill": true, "success": true, "outline": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `defaultTheme` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Default Theme Taglist Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with the default `warning` theme."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-taglist", { "value": tags, "pill": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `transparentTaglist` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Transparent Taglist Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with a transparent style and pill shape."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-taglist", { "value": tags, "pill": true, "transparent": true, "error": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("a", { "name": `advancedStyledTaglist` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Advanced Styled Taglist Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Renders a taglist with a mix of styles, colors, and shapes."))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `basis-third-10 lg:basis-half-10 md:basis-full mb-20` }, [
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 h-auto flex flex-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("format-taglist", { "value": ["Foo", "bar", "baz"], "rounded": true, "success": true, "outline": true, "solid": true }),
                      import_Document.default.createText(`
            `, false)
                    ]),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/format/table.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/text.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "5f24358a90e3669c41e0";
