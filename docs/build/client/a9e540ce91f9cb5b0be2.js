var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\format\date.ink
  var date_exports = {};
...
`, false)
  ...
  var Date_35847380257edd037c2b = class extends import_Component16.default {
...
`, false),
  ...
  var TemplateDocument = class _TemplateDocument extends import_Document2.default {
    ...
    template() {
      ...
      const recentDate = new Date(Date.now() - 5 * 60 * 1e3).toISOString();
      return [
...
`, false)
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      ...
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#defaultFormat` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Default Format"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#customFormats` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Custom Formats"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#relativeTimeAgo` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Relative Time (Ago)"))
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("a", { "class": `block tx-t-1`, "href": `#shortRelativeTime` }, [
                        import_Document.default.createText(`\u2022 `, false),
                        ...this._toNodeList(_("Short Relative Time"))
                      ]),
                      import_Document.default.createText(`
            `, false)
                    ]),
      ...
      `, false),
        ...
        `, false),
          ...
          <!-- Default Format -->
          `, false),
                  import_Document.default.createElement("a", { "name": `defaultFormat` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Default Format"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Displays the current date in the default format (MMMM D, YYYY, h:mm:ss a)."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          <!-- Custom Formats -->
          `, false),
                  import_Document.default.createElement("a", { "name": `customFormats` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Custom Formats"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("Displays a specific date in various Day.js-compatible formats."))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          <!-- Relative Time (Ago) -->
          `, false),
                  import_Document.default.createElement("a", { "name": `relativeTimeAgo` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Relative Time (Ago)"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_('Displays a date as relative time using the "ago" format.'))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `bg-t-3 p-10 mb-20` }, [
          ...
          <!-- Short Relative Time -->
          `, false),
                  import_Document.default.createElement("a", { "name": `shortRelativeTime` }, []),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    ...this._toNodeList(_("Short Relative Time"))
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_('Displays a date as short relative time using the "a" format.'))
                  ]),
                  import_Document.default.createText(`
          `, false),
                  import_Document.default.createElement("div", { "class": `bg-t-3 p-10 mb-20` }, [
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/format/currency.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/format/email.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "a9e540ce91f9cb5b0be2";
