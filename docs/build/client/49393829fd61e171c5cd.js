...
`, false),
  ...
  var Pager_ad6fe2ba5cdf028f153c = class extends import_Component18.default {
    ...
    template() {
      ...
      if (border) {
        ...
        (0, import_color5.default)(border, styles, false, ".control, a, span", "border-color");
      }
      if (background) {
        (0, import_color5.default)(background, styles, false, ".control, a, span", "background-color");
      }
      (0, import_bold2.default)(this.props, styles, "span");
      (0, import_underline2.default)(this.props, styles, "a");
      if (link) {
        (0, import_color5.default)(link, styles, false, "a", "color");
      }
...
`, false),
  ...
  `, false),
          ...!!(rewind && state.range[0] !== 1) ? [
            import_Registry18.default.createText(`
    `, false),
            import_Registry18.default.createComponent("interface-icon", Icon_33cb84912ffcb000a388, { ...iconProps, "class": `control`, "name": `angles-left`, "click": handlers.rewind }).element,
            import_Registry18.default.createText(`
  `, false)
          ] : [],
          import_Registry18.default.createText(`
  `, false),
          ...!!(prev && state.current > 1) ? [
            import_Registry18.default.createText(`
    `, false),
            import_Registry18.default.createComponent("interface-icon", Icon_33cb84912ffcb000a388, { ...iconProps, "class": `control`, "name": `angle-left`, "click": handlers.prev }).element,
            import_Registry18.default.createText(`
  `, false)
          ] : [],
          import_Registry18.default.createText(`
  `, false),
    ...
    `, false)
              ...
              import_Registry18.default.createText(`
      `, false),
              import_Registry18.default.createElement("a", { "click": handlers.click }, [
                ...this._toNodeList(page)
              ]).element,
              import_Registry18.default.createText(`
    `, false)
  ...
  `, false),
          ...!!(next && state.current < state.pages) ? [
            import_Registry18.default.createText(`
    `, false),
            import_Registry18.default.createComponent("interface-icon", Icon_33cb84912ffcb000a388, { ...iconProps, "class": `control`, "name": `angle-right`, "click": handlers.next }).element,
            import_Registry18.default.createText(`
  `, false)
          ] : [],
          import_Registry18.default.createText(`
  `, false),
          ...!!(forward && state.range[1] !== state.pages) ? [
            import_Registry18.default.createText(`
    `, false),
            import_Registry18.default.createComponent("interface-icon", Icon_33cb84912ffcb000a388, { ...iconProps, "class": `control`, "name": `angles-right`, "click": handlers.forward }).element,
            import_Registry18.default.createText(`
  `, false)
          ] : [],
          import_Registry18.default.createText(`
