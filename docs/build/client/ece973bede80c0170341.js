var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\field\rating.ink
  var rating_exports = {};
...
`, false)
  ...
  var Rating_2d6a3c2d29eb25c7053c = class extends import_Component16.default {
...
`, false),
        import_Registry16.default.createElement("template", { "type": `light` }, [
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("input", { "type": `hidden`, "name": name, "value": String(state.value.value) }).element,
          import_Registry16.default.createText(`
`, false)
        ]).element,
        import_Registry16.default.createText(`
`, false),
  ...
  `, false),
          ...Object.entries(state.value.stars).map(([i, star]) => [
            import_Registry16.default.createText(`
    `, false),
            import_Registry16.default.createElement("span", { "click": () => rate(parseInt(i) + 1) }, [
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("p", { "class": `mb-20` }, [
                    ...this._toNodeList(_("The `<field-rating>` component provides a star-based rating system for user input. Below are its props:"))
                  ]),
                  import_Document.default.createText(`
          `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/field/range.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "ece973bede80c0170341";
