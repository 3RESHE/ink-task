...
`, false)
  ...
  var Select_180142206112824ab003 = class extends import_Component16.default {
      ...
      `, false),
        ...
        `, false),
                ...!!(state.value.selected.length > 0) ? [
                  import_Registry16.default.createText(`
          `, false),
                  import_Registry16.default.createElement("slot", { "name": `selected` }, []).element,
                  import_Registry16.default.createText(`
        `, false)
                ] : !!placeholder ? [
                  ,
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false)
                      ...
                      import_Registry16.default.createText(`
              `, false),
                      import_Registry16.default.createElement("input", { "class": `input`, "value": state.value.query }).element,
                      import_Registry16.default.createText(`
            `, false)
                    ] : [],
                    import_Registry16.default.createText(`
            `, false),
                    ...!!custom ? [
                      import_Registry16.default.createText(`
              `, false),
                      import_Registry16.default.createElement("i", { "class": `add fas fa-fw fa-plus`, "click": add }, []).element,
                      import_Registry16.default.createText(`
            `, false)
                    ] : true ? [
                      ,
        ...
        `, false),
                import_Registry16.default.createElement("div", { "class": `options` }, [
                  import_Registry16.default.createElement("slot", { "name": `filtered` }, []).element
                ]).element,
                import_Registry16.default.createText(`
      `, false)
              ]).element,
...
`, false)
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
              ...
              `, false),
                      import_Document.default.createElement("table-col", {}, [
                        import_Document.default.createText(`custom`, false)
                      ]),
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("table-col", {}, [
 ...
 <!-- Styled Select Input -->
          ...
          `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    ...this._toNodeList(_("A styled select input with custom options, styling, and hover effects using Ink utilities."))
                  ]),
                  import_Document.default.createText(`
          `, false),
            ...
            `, false),
                    import_Document.default.createElement("div", { "class": `bg-t-3 p-10 flex flex-col items-center justify-center` }, [
                      import_Document.default.createText(`
              `, false),
                      import_Document.default.createElement("field-select", { "name": `category`, "placeholder": `Select Category`, "custom": true, "class": `w-200 p-5 b-solid b-t-2 c-5 bg-white tx-t-1 transition-300 hover:b-primary hover:shadow-0-2-8-t-3`, "style": `cursor: pointer;` }, [
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("option", { "value": `tech` }, [
                          import_Document.default.createText(`Technology`, false)
                        ]),
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("option", { "value": `sports` }, [
                          import_Document.default.createText(`Sports`, false)
                        ]),
                        import_Document.default.createText(`
                `, false),
                        import_Document.default.createElement("option", { "value": `music` }, [
                          import_Document.default.createText(`Music`, false)
                        ]),
                        import_Document.default.createText(`
              `, false)
                      ]),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/field/rating.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "6c6170f4af919520d780";
