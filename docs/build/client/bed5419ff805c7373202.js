var InkAPI = (() => {
  ...
  // ink-document-client-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\field\radio.ink
  var radio_exports = {};
...
`, false)
  ...
  var Radio_7eb23fa5e323e66c0392 = class extends import_Field.default {
    ...
    template() {
      const { label = "", change, update, attributes } = (0, import_option.getProps)(this);
      const styles = new import_StyleSet11.default();
      this.styles = () => styles.toString();
      (0, import_display3.default)(this.props, styles, "inline-block", ":host");
      (0, import_option.setStyles)(this.props, styles, "circle");
...
`, false),
        import_Registry16.default.createElement("label", { "mount": handlers.mount }, [
          import_Registry16.default.createText(`
  `, false),
          import_Registry16.default.createElement("input", { ...attributes, "type": `radio`, "change": handlers.change, "click": handlers.click }).element,
          import_Registry16.default.createText(`
  `, false),
      ...
      />
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/ui/field/password.html` }, [
                      import_Document.default.createText(`
              `, false),
...
`, false)
  ...
  var BUILD_ID = "bed5419ff805c7373202";
