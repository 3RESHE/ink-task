...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\alert.ink
  var alert_exports = {};
  __export(alert_exports, {
    default: () => Alert_45cd0fb82d8a4dae3718
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\alert.ink
  var Alert_45cd0fb82d8a4dae3718 = class extends import_Document2.default {
    id() {
      return "45cd0fb82d8a4dae3718";
    }
    styles() {
      return `@ink theme;
  @ink reset;
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#alert` }, [
                      ...this._toNodeList(_("Alert"))
                    ]),
                    import_Document.default.createText(`
            `, false),
...
`, false)
          ...
          `, false),
                  import_Document.default.createElement("ide-code", { "class": `scroll-y-auto`, "class": `mb-5`, "trim": true, "detab": 12 }, [
                    ...this._toNodeList(`
            <element-alert info>
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "class": `mb-5`, "warning": true }, [
                    import_Document.default.createText(`
            `, false),
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "class": `mb-5`, "error": true }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("element-icon", { "name": `exclamation-circle` }),
                    import_Document.default.createText(`
            Could not save
          `, false)
                  ]),
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "class": `mb-5`, "color": `salmon` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("element-icon", { "name": `exclamation-circle` }),
                    import_Document.default.createText(`
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "class": `mb-5`, "transparent": true, "info": true }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("element-icon", { "name": `info-circle` }),
                    import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "class": `mb-5`, "outline": true, "warning": true }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("element-icon", { "name": `exclamation-triangle` }),
                    import_Document.default.createText(`
