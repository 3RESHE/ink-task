...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\json.ink
  var json_exports = {};
  __export(json_exports, {
    default: () => Json_50b5e7a120c58b35d7e7
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\json.ink
  var Json_50b5e7a120c58b35d7e7 = class extends import_Document2.default {
    id() {
      return "50b5e7a120c58b35d7e7";
    }
    styles() {
      return `@ink theme;
  @ink reset;
