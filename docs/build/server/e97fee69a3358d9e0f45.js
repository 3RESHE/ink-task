...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\icons.ink
  var icons_exports = {};
  __export(icons_exports, {
    default: () => Icons_e97fee69a3358d9e0f45
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\icons.ink
  var Icons_e97fee69a3358d9e0f45 = class extends import_Document2.default {
    id() {
      return "e97fee69a3358d9e0f45";
    }
    styles() {
      return `@ink theme;
  @ink reset;
        ...
        `, false),
            ...
            `, false),
                  import_Document.default.createElement("nav", { "class": `tx-14 tx-lh-32` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `block tx-t-0`, "href": `#icons` }, [
      ...
      `, false),
        ...
        `)
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/ui/components/loaders.html` }, [
                      import_Document.default.createText(`
              `, false),
