...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\index.ink
  var ui_exports = {};
  __export(ui_exports, {
    default: () => Index_a03a5047a431cfb03202
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\index.ink
  var Index_a03a5047a431cfb03202 = class extends import_Document2.default {
    id() {
      return "a03a5047a431cfb03202";
    }
    styles() {
      return `@ink theme;
  @ink reset;
