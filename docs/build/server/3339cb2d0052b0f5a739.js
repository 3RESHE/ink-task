...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\loaders.ink
  var loaders_exports = {};
  __export(loaders_exports, {
    default: () => Loaders_3339cb2d0052b0f5a739
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\components\loaders.ink
  var Loaders_3339cb2d0052b0f5a739 = class extends import_Document2.default {
    id() {
      return "3339cb2d0052b0f5a739";
    }
    styles() {
      return `@ink theme;
  @ink reset;
  ...
  @ink utilities;`;
    ...
    template() {
      ...
      const crumbs = [
        ...
        { icon: " Loaders", label: "UI", href: "/ink/ui/index.html" },
        { icon: " Loaders", label: "Components", href: "/ink/ui/index.html" },
        { label: " Loaders" }
      ];
      return [
      ...
      `, false),
        ...
        `, false),
                  import_Document.default.createElement("div", { "class": `mb-10` }, [
                    import_Document.default.createText(`
           Loaders have different types based on their usage:
          `, false),
        ...
        `, false),
                  import_Document.default.createElement("ide-code", { "class": `mb-10`, "trim": true, "detab": 12 }, [
                    ...this._toNodeList(`
        ...
        `)
            ...
            `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    import_Document.default.createText(`
            `, false),
                    ...this._toNodeList(_("Basic  Loaders")),
                    import_Document.default.createText(`
            `, false)
                  ]),
                  import_Document.default.createText(`
            ...
            `, false),
                  import_Document.default.createElement("h2", { "class": `tx-primary tx-upper tx-30 py-20` }, [
                    import_Document.default.createText(`
            `, false),
                    ...this._toNodeList(_("Solid vs. Brand  Loaders")),
                    import_Document.default.createText(`
            `, false)
                  ]),
                  import_Document.default.createText(`
            ...
            Use `, false),
                    ...
                    import_Document.default.createText(` for default  Loaders and `, false),
                    import_Document.default.createElement("code", {}, [
                      import_Document.default.createText(`brand`, false)
                    ]),
        ...
        `)
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `c/ink/ui/components/loaders.html` }, [
                      import_Document.default.createText(`
              `, false),
                      ...this._toNodeList(_("Loaders")),
                      import_Document.default.createText(`
...
`, false)
  ...
  return __toCommonJS(loaders_exports);
})();
;
