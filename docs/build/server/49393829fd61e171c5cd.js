...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\components\pager.ink
  var pager_exports = {};
  __export(pager_exports, {
    default: () => Pager_49393829fd61e171c5cd
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink-task\packages\ink-web\src\pages\ui\components\pager.ink
  var Pager_49393829fd61e171c5cd = class extends import_Document2.default {
    id() {
      return "49393829fd61e171c5cd";
    }
    styles() {
      return `@ink theme;
  @ink reset;
