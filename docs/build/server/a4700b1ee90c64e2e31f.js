...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\overflow.ink
  var overflow_exports = {};
  __export(overflow_exports, {
    default: () => Overflow_a4700b1ee90c64e2e31f
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\overflow.ink
  var Overflow_a4700b1ee90c64e2e31f = class extends import_Document2.default {
    id() {
      return "a4700b1ee90c64e2e31f";
    }
    styles() {
      return `@ink theme;
  @ink reset;
