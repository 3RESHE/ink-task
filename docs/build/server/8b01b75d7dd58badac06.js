...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\formula.ink
  var formula_exports = {};
  __export(formula_exports, {
    default: () => Formula_8b01b75d7dd58badac06
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\formula.ink
  var Formula_8b01b75d7dd58badac06 = class extends import_Document2.default {
    id() {
      return "8b01b75d7dd58badac06";
    }
    styles() {
      return `@ink theme;
  @ink reset;
