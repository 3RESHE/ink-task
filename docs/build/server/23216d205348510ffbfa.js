...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\separated.ink
  var separated_exports = {};
  __export(separated_exports, {
    default: () => Separated_23216d205348510ffbfa
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\separated.ink
  var Separated_23216d205348510ffbfa = class extends import_Document2.default {
    id() {
      return "23216d205348510ffbfa";
    }
    styles() {
      return `@ink theme;
  @ink reset;
