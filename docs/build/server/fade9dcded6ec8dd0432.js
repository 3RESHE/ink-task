...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\docs\developer-tools.ink
  var developer_tools_exports = {};
  __export(developer_tools_exports, {
    default: () => DeveloperTools_fade9dcded6ec8dd0432
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\docs\developer-tools.ink
  var DeveloperTools_fade9dcded6ec8dd0432 = class extends import_Document2.default {
    id() {
      return "fade9dcded6ec8dd0432";
    }
    styles() {
      return `@ink theme;
  @ink reset;
        ...
        `, false),
          ...
          `, false),
                  import_Document.default.createElement("ide-app", { "title": `src/index.ts`, "class": `py-20` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("ide-code", { "lang": `js`, "numbers": true, "trim": true, "detab": 12 }, [
                      ...this._toNodeList(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/docs/component-publisher.html` }, [
                      import_Document.default.createText(`
              `, false),
