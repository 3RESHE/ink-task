...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\imagelist.ink
  var imagelist_exports = {};
  __export(imagelist_exports, {
    default: () => Imagelist_7c6d2794e8e5fcbff944
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\ui\format\imagelist.ink
  var Imagelist_7c6d2794e8e5fcbff944 = class extends import_Document2.default {
    id() {
      return "7c6d2794e8e5fcbff944";
    }
    styles() {
      return `@ink theme;
  @ink reset;
