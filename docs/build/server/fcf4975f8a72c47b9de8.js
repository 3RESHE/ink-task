...
${document2.replace("__TEMPLATE_DATA__", client)}`;
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\docs\client-api.ink
  var client_api_exports = {};
  __export(client_api_exports, {
    default: () => ClientApi_fcf4975f8a72c47b9de8
  });
  ...
  // ink-document-server-resolver:C:\Users\Win 10\dev\ink\packages\ink-web\src\pages\docs\client-api.ink
  var ClientApi_fcf4975f8a72c47b9de8 = class extends import_Document2.default {
    id() {
      return "fcf4975f8a72c47b9de8";
    }
    styles() {
      return `@ink theme;
  @ink reset;
...
`, false)
      ...
      `, false),
        ...
        `, false),
          ...
          `, false),
            ...
            `, false),
                    import_Document.default.createElement("ide-code", { "inline": true }, [
                      import_Document.default.createText(`InkAPI`, false)
                    ]),
                    import_Document.default.createText(` that includes all the 
          ...
          `, false),
                  import_Document.default.createElement("element-alert", { "curved": true, "secondary": true, "class": `tx-lh-24` }, [
                    import_Document.default.createText(`
            `, false),
            ...
            `, false),
                    ...
                    import_Document.default.createText(` Using the client API in the wrong 
          ...
          `, false),
                  import_Document.default.createElement("api-ui", { "start": `InkAPI` }),
                  import_Document.default.createText(`
          ...
          `, false),
                  import_Document.default.createElement("nav", { "class": `flex` }, [
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `tx-primary py-40`, "href": `/ink/docs/compiler-api.html` }, [
                      import_Document.default.createText(`
              `, false),
            ...
            `, false)
                    ...
                    import_Document.default.createText(`
            `, false),
                    import_Document.default.createElement("a", { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/docs/template-engine.html` }, [
                      import_Document.default.createText(`
              `, false),
                      ...this._toNodeList(_("Template Engine")),
                      import_Document.default.createText(`
